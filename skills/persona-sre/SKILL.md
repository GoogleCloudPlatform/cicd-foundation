...
license: Apache-2.0
allowed-tools: skills/persona-sre/scripts/dbus_session_cmd.sh skills/persona-sre/scripts/manage_workstation.sh skills/persona-sre/scripts/monitor_build.sh skills/persona-sre/scripts/trigger_build.py skills/persona-sre/tests/test_manage_workstation.bats skills/persona-sre/tests/test_trigger_build.py
metadata:
