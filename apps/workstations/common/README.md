...
This module outputs an asset provider (`COPY --from=common-provider /export /`), meaning downstream runtime layers simply inherit configurations rather than duplicating setup logic.
